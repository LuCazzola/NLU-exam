...
from functions import init_modelComponents, init_logger, train_loop, eval_loop, get_args, get_num_parameters, save_model 
...
if __name__ == "__main__":
    ...
    if not args.test_only :
        # Train the model
        best_model = train_loop(model, train_loader, val_loader, optimizer, criterion_train, criterion_eval,
        ...
        # For consistency, return the input model itself is fed to the eval loop as "best model"
        best_model = model
